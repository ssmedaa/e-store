...
const db = mysql.createConnection({
    ...
    password: 'EECS4413', // Replace with your MySQL password
    database: 'bookstore'
});
...
db.connect(err => {
    ...
    insertBooks(); // Call the function to insert books
});

// Array of books to be inserted
const books = [
{
        id: 1,
...
// Function to insert all books into the database
function insertBooks() {
    books.forEach(book => {
        const query = `
            INSERT INTO books (title, url, originalPrice, salePrice, rating, stripeID, category, summary1, summary2)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
        `;
